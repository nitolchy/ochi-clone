        ...
        <div className='px-20'>
          <div className="cards w-full flex gap-10 mt-10">
              <motion.div onHoverStart={()=>handleHover(0)} onHoverEnd={()=>handleHoverEnd(0)} className="cardcontainer relative w-1/2 h-[75vh]   ">
                <h1 className='absolute flex overflow-hidden -translate-x-1/2 top-1/2 -translate-y-1/2 left-full z-[9] -pb-20  text-[#CDEA68] leading-none tracking-tighter text-8xl'>
              ...
              <h1 className='absolute flex overflow-hidden translate-x-1/2 top-1/2 -translate-y-1/2 right-full z-[9] -pb-20  text-[#CDEA68] leading-none tracking-tighter text-8xl'>
