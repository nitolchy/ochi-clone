...
function About() {
  return (
    <div className='w-full p-20 bg-[#CDEA68] rounded-tl-3xl rounded-tr-3xl text-black' >
      ...
      <div className='w-full h-[1vw] border-t-[1px] pt-20 mt-20 border-[#a1b562]'></div>
       <div className='flex gap-5'>
        <div className='w-1/2 '>
        <h1 className='text-7xl'>Our approach:</h1>
          <button className='px-10 py-6 flex gap-10 items-center uppercase bg-zinc-900 mt-10 rounded-full text-white'>Read More
